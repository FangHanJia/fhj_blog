        ...
        <el-card shadow="never" style="margin-bottom: 20px">
            <el-form ref="form" :model="form" label-width="80px" :rules="ruleValidate">
                ...
                <el-form-item>
                    ...
                    <el-button @click="$router.push('/pc/blog/blogMain')">返回</el-button>
                </el-form-item>
            </el-form>
        </el-card>
...
<script>
    ...
    import TokenDialog from '../common/tokenDialog.vue';
    ...
    export default {
        ...
        mounted() {
            ...
            gistApi.getSingleNew(this.form.id).then((response) => {
            ...
            submitHandle() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        gistApi.editBlog(this.form).then((response) => {
                            let result = response.data
                            this.$message({
                                message: '修改成功',
                                type: 'success'
